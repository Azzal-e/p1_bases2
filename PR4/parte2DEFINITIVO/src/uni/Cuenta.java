...
@DiscriminatorColumn(name = "ESCUENTACORRIENTE", discriminatorType = DiscriminatorType.INTEGER)
public abstract class Cuenta {
    ...
    @Column(name = "ESCUENTACORRIENTE", nullable = false,  insertable = false, updatable = false)
