ALTER TABLE Operacion DISABLE TRIGGER ALL;
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-05-11','YYYY-MM-DD'), TO_TIMESTAMP('2024-10-30','YYYY-MM-DD') + INTERVAL '1 second'),
  795375614.29,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-12-01','YYYY-MM-DD'), TO_TIMESTAMP('2025-02-07','YYYY-MM-DD') + INTERVAL '1 second'),
  829761618.32,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-11-21','YYYY-MM-DD'), TO_TIMESTAMP('2024-03-29','YYYY-MM-DD') + INTERVAL '1 second'),
  393964629.32,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2025-02-07','YYYY-MM-DD'), TO_TIMESTAMP('2024-05-17','YYYY-MM-DD') + INTERVAL '1 second'),
  77646300.5,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-09-14','YYYY-MM-DD'), TO_TIMESTAMP('2024-10-27','YYYY-MM-DD') + INTERVAL '1 second'),
  87276994.05,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2025-02-19','YYYY-MM-DD'), TO_TIMESTAMP('2024-11-18','YYYY-MM-DD') + INTERVAL '1 second'),
  23150446.02,
...
VALUES (
  68,
  ROW('ES12','39593283634492562374')::IBAN,
  GREATEST(TO_TIMESTAMP('2024-04-16','YYYY-MM-DD'), TO_TIMESTAMP('2024-10-30','YYYY-MM-DD') + INTERVAL '1 second'),
  829765261.68,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-07-08','YYYY-MM-DD'), TO_TIMESTAMP('2025-01-23','YYYY-MM-DD') + INTERVAL '1 second'),
  744003120.42,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2025-01-25','YYYY-MM-DD'), TO_TIMESTAMP('2024-07-21','YYYY-MM-DD') + INTERVAL '1 second'),
  733668686.16,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-11-20','YYYY-MM-DD'), TO_TIMESTAMP('2024-03-25','YYYY-MM-DD') + INTERVAL '1 second'),
  423560731.87,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-07-10','YYYY-MM-DD'), TO_TIMESTAMP('2025-01-10','YYYY-MM-DD') + INTERVAL '1 second'),
  191195910.91,
  'Vestibulum sed magna at nunc commodo placerat. Praesent blandit.',
  'RETIRADA',
  2284
...
ALTER TABLE Operacion ENABLE TRIGGER ALL;
