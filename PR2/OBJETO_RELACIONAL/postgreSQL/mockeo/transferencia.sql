...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-07-13','YYYY-MM-DD'), TO_TIMESTAMP('2025-01-08','YYYY-MM-DD') + INTERVAL '1 second'),
  218464836.96,
  'Sed ante.'
);
...
VALUES (
  ...
  ROW('ES12','78579706658008173005')::IBAN,
  GREATEST(TO_TIMESTAMP('2024-12-01','YYYY-MM-DD'), TO_TIMESTAMP('2024-03-25','YYYY-MM-DD') + INTERVAL '1 second'),
  702761725.77,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-12-02','YYYY-MM-DD'), TO_TIMESTAMP('2024-11-05','YYYY-MM-DD') + INTERVAL '1 second'),
  399009657.36,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-12-13','YYYY-MM-DD'), TO_TIMESTAMP('2024-10-19','YYYY-MM-DD') + INTERVAL '1 second'),
  772701005.03,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2025-02-24','YYYY-MM-DD'), TO_TIMESTAMP('2024-12-03','YYYY-MM-DD') + INTERVAL '1 second'),
  616241137.19,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-07-18','YYYY-MM-DD'), TO_TIMESTAMP('2024-06-07','YYYY-MM-DD') + INTERVAL '1 second'),
  485492446.71,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-11-19','YYYY-MM-DD'), TO_TIMESTAMP('2024-07-21','YYYY-MM-DD') + INTERVAL '1 second'),
  974906701.04,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-06-30','YYYY-MM-DD'), TO_TIMESTAMP('2024-12-28','YYYY-MM-DD') + INTERVAL '1 second'),
  418832502.06,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-12-20','YYYY-MM-DD'), TO_TIMESTAMP('2024-06-07','YYYY-MM-DD') + INTERVAL '1 second'),
  518419679.02,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-08-09','YYYY-MM-DD'), TO_TIMESTAMP('2024-07-31','YYYY-MM-DD') + INTERVAL '1 second'),
  278936883.73,
...
VALUES (
  ...
  GREATEST(TO_TIMESTAMP('2024-08-21','YYYY-MM-DD'), TO_TIMESTAMP('2025-01-13','YYYY-MM-DD') + INTERVAL '1 second'),
  713009156.77,
