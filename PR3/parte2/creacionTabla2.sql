...
CREATE TABLE PERSON (
    ...
    CONSTRAINT CHECK_ESPECIALTY_CLIENT CHECK ((IS_CLIENT = TRUE AND 
                                                HAS_MEMBER_CARD IS NOT NULL) OR
                                                (IS_CLIENT = FALSE AND
                                                HAS_MEMBER_CARD IS NULL)),
    CONSTRAINT CHECK_ESPECIALTY_EMPLOYEE CHECK ((IS_EMPLOYEE = TRUE AND 
                                                ...
                                                (IS_EMPLOYEE = FALSE AND
                                                NUMBER_OF_SALES IS NULL AND
                                                EMPLOYEE_NUMBER IS NULL)),
    CONSTRAINT CHECK_EMPLOYEE_NUMBER CHECK (EMPLOYEE_NUMBER >= 0)
);
...
CREATE TABLE PRODUCT (
    ...
    CONSTRAINT PK_PRODUCT PRIMARY KEY (ID, CIF_STORE),
